...
- [ ] **Lokální displej:** Zobrazit naměřené hodnoty na grafickém LCD připojeném k Arduinu UNO R4 WiFi.
...
- [ ] **Síťové nastavení:** Konfigurovat Ethernet na RPi s IP `10.250.1.x/24` (dle čísla týmu) a bránou `10.250.1.1`.
...
- [ ] **Autorizace:** Omezit přístup k webové stránce pomocí uživatelského jména a hesla.
- [ ] **Firewall:** Nastavit pravidla firewallu na RPi (povolit pouze nezbytné porty pro služby).